...
!function (t, e) {
    ...
    function i(i, s, a) {
        ...
        a = a || e || t.jQuery,
        a && (
            s.prototype.option || (s.prototype.option = function (t) {
...
function (t, e) {
    ...
    function o(t) {
        ...
        return e || a(
            "Style returned " + e + ". Are you running this code in a hidden iframe on Fire" +
            "fox? See https://bit.ly/getsizebug1"
        ),
        e
    }
    function n() {
...
function (t, e) {
    ...
    var s = document.documentElement.style,
        r = "string" == typeof s.transition
            ? "transition"
            : "WebkitTransition",
        a = "string" == typeof s.transform
            ? "transform"
            : "WebkitTransform",
        u = {
    ...
    d.getPosition = function () {
        var t = getComputedStyle(this.element),
            e = this
                .layout
                ._getOption("originLeft"),
            i = this
                .layout
                ._getOption("originTop"),
            o = t[
                e
                    ? "left"
                    : "right"
...
function (t, e) {
    ...
    c._manageStamps = function () {
        this.stamps && this.stamps.length && (
...
function (t, e) {
    ...
    o._getHorizontalColPosition = function (t, e) {
        ...
        return this.horizontalColIndex = n
            ? i + t
    ...
    o._manageStamp = function (t) {
        ...
        u -= r % this.columnWidth
            ? 0
            : 1,
        u = Math.min(this.cols - 1, u);
        for (var h = this._getOption("originTop"), d = (
            h
                ? o.top
                : o.bottom
        ) + i.outerHeight, l = a; l <= u; l++) 
            this.colYs[l] = Math.max(d, this.colYs[l])
    },
    o._getContainerSize = function () {
        this.maxY = Math
            .max
            .apply(Math, this.colYs);
        var t = {
            height: this.maxY
        };
